...
- [ ] Fotos de capa dos 3 novos posts do blog (voo cancelado, golpe do Pix, plano de saúde) usam fotos genéricas do escritório em `fotos/` por falta de imagem específica do tema. Trocar por fotos temáticas (aeroporto, app bancário, atendimento médico) quando disponíveis — arquivos: `blog/voo-cancelado-atrasado-indenizacao.html`, `blog/golpe-pix-cobranca-indevida-banco.html`, `blog/plano-saude-negou-cobertura.html`.
